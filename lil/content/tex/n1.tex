...
\begin{align*}
	\nabla \mathcal{X}_n &= i \cdot \frac{\partial}{\partial \, \sum_{k=1}^{\infty} \mathcal{T}_k \otimes \mathcal{Y}_k \otimes C_k}.
\end{align*}
Where $C_k$ is a non-zero constant term in $\mathbb{R}$. Where $\mathcal{X}$ is a sum of tensor products of $\mathcal{T}_k$ and $\mathcal{Y}_k$ for $k=1,2,\ldots$.
\end{theorem}
