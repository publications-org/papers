...
\begin{theorem}
	...
	\begin{align*}
		\mathcal{V} &= \int (\lambda + \mu)\sqrt{ax^2 + bx  +c} \operatorname{dx}.
	\end{align*}
	We define three equations for $\forall \mathcal{V}', \operatorname{d}(\lambda + \mu) \in \mathbb{R}.$:
	\begin{align*}
		\mathcal{V}' &= (\lambda + \mu)\sqrt{ax^2 + bx  +c}x \int x \operatorname{d}(\lambda + \mu)\sqrt{ax^2 + bx  +c},\\
	\end{align*}
	And:
	\begin{align*}
		\frac{\mathcal{V}'}{(\lambda + \mu)} &= \sqrt{ax^2 + bx  +c}x \int x \operatorname{d}(\lambda + \mu)\sqrt{ax^2 + bx  +c},\\
	\end{align*}
	And:
	\begin{align*}
		\sqrt{ax^2 + bx  +c}\frac{\mathcal{V}'}{(\lambda + \mu)} &= (\sqrt{ax^2 + bx  +c})^{2}x \int x \operatorname{d}(\lambda + \mu)\sqrt{ax^2 + bx  +c}.
	\end{align*}
...
\begin{corollary}
	...
	\begin{align*}
		\frac{\mathcal{V}}{(\lambda + \mu)} &= \int \sqrt{ax^2 + bx  +c} \operatorname{dx}.
	\end{align*}
