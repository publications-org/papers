...
\begin{theorem}
	Let a set of rational numbers $x \in \mathbb{R},$ in $\mu(n, p)  \in \mathbb{R},$ be in the following inequality:
	\begin{align*}
...
\begin{theorem}
	...
	\end{align*}
	Separately, let the followin $x, n \in \mathbb{R}$:
	\begin{align*}
	...
	\end{align*}
	Admits a transcendental number for $r \in \mathbb{R}$.
\end{theorem}
...
\begin{theorem}
	...
	\end{align*}
	Assuming $\phi(n^{s}!) \neq 0.$ And $\phi(n^{s}!) \in \mathbb{R}.$
\end{theorem}

\begin{theorem}
	Let a theorem the following equations for any $x, n \in \mathbb{R}$:
	\begin{align*}
...
\begin{theorem}
	Let a general theorem of the following for $x \in \mathbb{R}$ be:
	\begin{align*}
...
\begin{theorem}
	...
	\end{align*}
	We then would establish another identity $x \in \mathbb{R}.$:
	\begin{align*}
		x &= -\frac{(\log(\pi)!) (e \log(\pi))!}{\pi}, \quad x \neq 0.
	\end{align*}
	From the following for $x = \frac{ln(\pi^\mathrm{e})!}{\pi}, \quad x \in \mathbb{R}.$:
	\begin{align*}
		\frac{ln(\pi^\mathrm{e})!}{\pi} &= \frac{(\mathrm{e} \log(\pi))!}{\pi}.
	\end{align*}
\end{theorem}
